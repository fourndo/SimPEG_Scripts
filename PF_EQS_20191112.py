...
d0 = 0.0
if "subtract_mean" in list(input_dict.keys()) and input_dict["data_type"] in ['ubc_mag', 'ubc_grav', 'geosoft_grav', 'geosoft_mag']:
...
if "new_uncert" in list(input_dict.keys()) and input_dict["data_type"] in ['ubc_mag', 'ubc_grav', 'geosoft_grav', 'geosoft_mag']:
